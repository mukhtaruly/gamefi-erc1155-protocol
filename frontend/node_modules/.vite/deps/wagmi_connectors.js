import {
  RpcSchema_exports,
  mini_exports
} from "./chunk-4CL4PIHQ.js";
import "./chunk-U4DGUXCG.js";
import "./chunk-ANJCMEYS.js";
import {
  require_fast_safe_stringify
} from "./chunk-DVYLYGRV.js";
import {
  require_browser
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-CHUPGWPY.js";
import "./chunk-IXOPKWCV.js";
import "./chunk-3SQLIRQS.js";
import {
  withRetry,
  withTimeout
} from "./chunk-KEQVFFKU.js";
import {
  ...
  keccak_256,
  numberToHex
} from "./chunk-ISC3G3RA.js";
import "./chunk-EQ6OKEXX.js";
import "./chunk-RMLOTHEQ.js";
import {
  __commonJS,
  __toESM
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-ICUVH3I5.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-NDLWSQI2.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-ROPEXXTM.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-6JBBJP2Z.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./dist-XU6HV6X3.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-CC7Z6D5C.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-UDT634PO.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-7MA4CFQB.js");
