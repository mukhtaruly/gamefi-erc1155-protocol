...
var ICONS = {
  add: async () => (await import("./add-GN55PQY3.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-6WNYUH2V.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-3XTI3QEF.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-RSDX4FIN.js")).appStoreSvg,
  apple: async () => (await import("./apple-6GYHNXHW.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-BCZKWT4B.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-2WR3HLKA.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-23F2FLP3.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-G6FU333T.js")).arrowTopSvg,
  bank: async () => (await import("./bank-NZJUBMHG.js")).bankSvg,
  browser: async () => (await import("./browser-4ZDJ3NMK.js")).browserSvg,
  card: async () => (await import("./card-YIW74Q5D.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-2ZIZKI34.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-VRURSEVU.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-Z6DTBMY2.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-CB5KV47S.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-XSDZVHCM.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-YYGY46LT.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-DN34OOQ5.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-WIIBQALM.js")).clockSvg,
  close: async () => (await import("./close-H7HYHRPO.js")).closeSvg,
  compass: async () => (await import("./compass-SNROJ6UJ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-3LWS6MBF.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-7LETW6OR.js")).copySvg,
  cursor: async () => (await import("./cursor-JIORRFXO.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-DLDFAQO6.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-OHHLONR4.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-UY2OV2YN.js")).disconnectSvg,
  discord: async () => (await import("./discord-377RTVW6.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-EDFL7GO6.js")).etherscanSvg,
  extension: async () => (await import("./extension-65SCLNIF.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-QLGKHYO6.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-7BYBMZI2.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-7CZZR2ZV.js")).farcasterSvg,
  filters: async () => (await import("./filters-NEWU5QXI.js")).filtersSvg,
  github: async () => (await import("./github-XH2CRKDD.js")).githubSvg,
  google: async () => (await import("./google-6QVBGHBE.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-5E7W5PWV.js")).helpCircleSvg,
  image: async () => (await import("./image-W6IUK72Y.js")).imageSvg,
  id: async () => (await import("./id-IFQE77OG.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-EY7W7PGH.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-QWLDSYZR.js")).lightbulbSvg,
  mail: async () => (await import("./mail-VY22QYJD.js")).mailSvg,
  mobile: async () => (await import("./mobile-325TF62W.js")).mobileSvg,
  more: async () => (await import("./more-KJDUBORD.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-B4TFUYU5.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-57W2TPHE.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-CIV6SMM2.js")).offSvg,
  playStore: async () => (await import("./play-store-EFM3TP76.js")).playStoreSvg,
  plus: async () => (await import("./plus-I3E2NFPZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-CPZBGEI6.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-V4H5LP5C.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-TC55FFEN.js")).refreshSvg,
  search: async () => (await import("./search-KI4R47DQ.js")).searchSvg,
  send: async () => (await import("./send-QPPZATFV.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-HV3QYMD2.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-CBQFMSKY.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-AIBDZUXO.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-XMX5TQKP.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-NXETPUZT.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-QF6DON7C.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-35JVT2QH.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-NFXDS3WQ.js")).twitchSvg,
  twitter: async () => (await import("./x-D6ES4GPA.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-EALK7SWB.js")).twitterIconSvg,
  verify: async () => (await import("./verify-G4WKCUFL.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-YC2QVOZB.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-5AHKG243.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CXUYM57M.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CXUYM57M.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CXUYM57M.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-JMNJ7YT2.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-SGNX3CFK.js")).warningCircleSvg,
  x: async () => (await import("./x-D6ES4GPA.js")).xSvg,
  info: async () => (await import("./info-Q7MEIIN5.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-K44TJ4G7.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-J5TXKZOO.js")).reownSvg
};
...
//# sourceMappingURL=chunk-MLDQFAXE.js.map
